...
namespace promisPortal.Models
{
    public class portalMod
    {
        ...
        public List<IDictionary<string, string>> getQualityCalendar()
        {
            ...
            string query = "SELECT id,qualityMessage,DATE_FORMAT(date, '%m/%d') as new_date FROM quality_calendar;";
        ...
        public List<IDictionary<string, string>> getSafetyCalendar()
        {
            ...
            List<IDictionary<string, string>> results = new List<IDictionary<string, string>>();
            string query = "SELECT id,qualityMessage,DATE_FORMAT(date, '%m/%d') as new_date FROM safety_calendar;";
            results = Connection.GetDataAssociateArray(query, "GET SAFETY CALENDAR DATA", Connection.portal_connString);
            return results;
        }
        ...
        public IDictionary<string, string> getBroadcastByID(int newsID)
        {
            ...
            IDictionary<string, string> results = new Dictionary<string, string>();
            string query = "SELECT id,subject,body,photo_header,expiry_date,hyperlink,hyperlink_header FROM tarlac_broadcast WHERE id=" + newsID;
        ...
        public Boolean UploadDocumentsBroadcast(string title, string date, string body, string pic, string hyperlink, string hyperlink_header)
        {
