...
using promisPortal.Controllers;

namespace promisPortal.Models
{
    public class Connection
    {
        public static string expert_connstring = ConfigurationManager.ConnectionStrings["expert_connstring"].ConnectionString;
        public static string user_connstring = ConfigurationManager.ConnectionStrings["user_connstring"].ConnectionString;
        public static string cents_connstring = ConfigurationManager.ConnectionStrings["cents_connstring"].ConnectionString;
        public static string promis_connString = ConfigurationManager.ConnectionStrings["promis_connString"].ConnectionString;
        public static string localhost_connString = ConfigurationManager.ConnectionStrings["localhost_connString"].ConnectionString;
        public static string portal_connString = ConfigurationManager.ConnectionStrings["portal_connString"].ConnectionString;
